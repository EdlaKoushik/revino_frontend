        ...
        <div className="min-h-screen bg-[#f7f7fb] flex flex-col">
          ...
          <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-8 py-16 md:py-24">
            <div className="flex-1 md:pr-12">
              <h1 className="text-4xl md:text-5xl font-extrabold text-[#23234c] mb-6 leading-tight">
  ...
  <button className="inline-block px-8 py-4 rounded-xl bg-[#6c47ff] text-white font-bold text-lg shadow hover:bg-[#4f2fcf] transition">
    Get Started Free
          ...
          <section className="max-w-3xl mx-auto px-8 py-12">
            <h2 className="text-2xl font-bold text-[#6c47ff] mb-6 text-center">Frequently Asked Questions</h2>
          ...
          {/* Call to Action */}
          <section className="py-5 bg-[#6c47ff] text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to ace your next interview?</h2>
            <a href="/signup" className="inline-block px-8 py-4 rounded-xl bg-white text-[#6c47ff] font-bold text-lg shadow hover:bg-[#f3f0ff] transition">Start Practicing Free</a>
          </section>
